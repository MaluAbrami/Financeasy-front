...
export function CreateCategoryModal({ isOpen, onClose, onCreated }: Props) {
          ...
          <>
            ...
            {frequency === Frequency.Monthly && (
              <div className={styles.formContainer}>
                ...
                <input
                  ...
                  max={31}
                  value={dayOfMonth}
                  onChange={(e: ChangeEvent<HTMLInputElement>) => setDayOfMonth(Number(e.target.value))}
                  required
                />
              </div>
            )}
            ...
            {frequency === Frequency.Weekly && (
              <div className={styles.formContainer}>
                ...
                <select
                  value={dayOfWeek}
                  onChange={(e: ChangeEvent<HTMLSelectElement>) => setDayOfWeek(Number(e.target.value))}
                  required
                >
            ...
            <div className={styles.formContainer}>
              ...
              <select
                ...
                onChange={(e: ChangeEvent<HTMLSelectElement>) => setAdjustmentRule(e.target.value as AdjustmentRule)}
              >
